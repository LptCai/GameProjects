//成长·选择
var Gmap2 = (function (_super) {
    __extends(Gmap2, _super);
    function Gmap2() {
        _super.call(this);
        this.atenum = 0;
        this.init();
    }
    var __egretProto__ = Gmap2.prototype;
    ...
    __egretProto__.create_l0 = function () {
        ...
        this.walls = [];
        var wall0 = new Obstacle(0, 40, 100, false, 0, 0, 0); //left horizontal up
        var wall1 = new Obstacle(0, 40, 600, false, 0, 0, 0); //left hozirontal down
        var wall2 = new Obstacle(1, 360, 60, false, 0, 0, 0); //right vertical
        var wall3 = new Obstacle(0, 320, 400, false, 0, 0, 0); //right horizontal 
        var wall4 = new Obstacle(1, 80, 360, false, 0, 0, 0); //left vertical
        ...
        this.balls = [];
        var ball0 = new MemoryBall(80, 130, 0, 0);
        var ball1 = new MemoryBall(330, 360, 8, 0);
    ...
    __egretProto__.nextball = function () {
        if (this.balls[0].get_isAte() == true) {
...
Gmap2.prototype.__class__ = "Gmap2";
//# sourceMappingURL=Gmap2.js.map