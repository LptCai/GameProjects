//新生·希冀
var Gmap1 = (function (_super) {
    __extends(Gmap1, _super);
    function Gmap1() {
        _super.call(this);
        this.memnum = 0;
        this.init();
    }
    var __egretProto__ = Gmap1.prototype;
    ...
    __egretProto__.create_l0 = function () {
        this.walls = [];
        var wall0 = new Obstacle(0, 60, 120, false, 0, 0, 0); //up lfet
        var wall1 = new Obstacle(0, 180, 120, false, 0, 0, 0); //up middle
        var wall2 = new Obstacle(0, 300, 120, false, 0, 0, 0); //up right
        var wall3 = new Obstacle(0, 60, 510, false, 0, 0, 0); //down left
        var wall4 = new Obstacle(0, 180, 510, false, 0, 0, 0); //down middle
        var wall5 = new Obstacle(0, 300, 510, false, 0, 0, 0); //down right
        var wall6 = new Obstacle(1, 60, 150, false, 0, 0, 0); //left up
        var wall7 = new Obstacle(1, 60, 270, false, 0, 0, 0); //left middle
        var wall8 = new Obstacle(1, 60, 390, false, 0, 0, 0); //left down
        var wall9 = new Obstacle(1, 390, 150, false, 0, 0, 0); //right up
        var wall10 = new Obstacle(1, 390, 270, false, 0, 0, 0); //right middle
        var wall11 = new Obstacle(1, 390, 390, false, 0, 0, 0); //right down
        ...
        this.balls = [];
        var ball0 = new MemoryBall(300, 150, 4, 0);
        var ball1 = new MemoryBall(90, 240, 5, 0);
        var ball2 = new MemoryBall(350, 250, 5, 0);
    ...
    __egretProto__.removewall = function () {
        this.walls[1].y -= 2;
        this.walls[4].y += 3;
        this.walls[7].x -= 2;
        this.walls[10].x += 2;
        if (this.walls[1].y <= -30 && this.walls[4].y >= 800 && this.walls[7].x <= -30 && this.walls[10].x >= 480) {
            this._timer1.stop();
            var ball3 = new MemoryBall(60, 80, 6, 0);
            var ball4 = new MemoryBall(350, 80, 7, 0);
            this.balls.push(ball3);
            this.balls.push(ball4);
            this.addChild(this.balls[3]);
            this.addChild(this.balls[4]);
            //生成两堵移动的墙壁
            var wall12 = new Obstacle(0, -120, 20, true, 3, -120, 480);
            var wall13 = new Obstacle(0, -120, 300, true, 3, -120, 480);
...
Gmap1.prototype.__class__ = "Gmap1";
//# sourceMappingURL=Gmap1.js.map