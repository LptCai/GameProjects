var UIPanal = (function (_super) {
    __extends(UIPanal, _super);
    function UIPanal() {
        _super.call(this);
        this.l = 0;
        this.init();
    }
    var __egretProto__ = UIPanal.prototype;
    ...
    __egretProto__.startlevel = function () {
        if (this.l < 10) {
            this.levelnum.font = RES.getRes("levelfont_fnt");
        }
        else {
    ...
    __egretProto__.selected = function () {
        if (this.l < 10) {
    ...
    __egretProto__.levelinc = function () {
        if (this.l < 11) {
            this.l++;
            if (this.l < 10) {
    ...
    __egretProto__.leveldec = function () {
        if (this.l > 0) {
            this.l--;
            if (this.l < 10) {
                if (this.levelTen != null && this.levelTen.parent != null) {
    ...
    __egretProto__.rbtnup = function () {
        this.help.texture = RES.getRes("help_up_png");
        DataStruct.stage.dispatchEvent(new egret.Event("help"));
    };
    __egretProto__.rbtndown = function () {
        this.help.texture = RES.getRes("help_down_png");
    };
    return UIPanal;
})(egret.Sprite);
UIPanal.prototype.__class__ = "UIPanal";
//# sourceMappingURL=UIPanal.js.map