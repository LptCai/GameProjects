...
unsigned char *LoadBitmapFile(char *filename, BITMAPINFOHEADER *bitmapInfoHeader)
{
	...
	int biSize = bitmapInfoHeader->biWidth * bitmapInfoHeader->biHeight * 3;
	bitmapInfoHeader->biSizeImage = biSize;
	bitmapImage = (unsigned char*)malloc(biSize);
	...
	fread(bitmapImage, 1, biSize, filePtr);
	...
	for (imageIdx = 0; imageIdx < biSize; imageIdx += 3)
	{
