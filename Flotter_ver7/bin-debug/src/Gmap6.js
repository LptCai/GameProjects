//坠落·停靠
var Gmap6 = (function (_super) {
    __extends(Gmap6, _super);
    function Gmap6() {
        _super.call(this);
        this.setTowall1 = false;
        this.setTowall0 = false;
        this.memnum = 0;
        this.init();
    }
    var __egretProto__ = Gmap6.prototype;
    ...
    __egretProto__.create_l0 = function () {
        this.walls = [];
        var wall0 = new Obstacle(0, 190, 100, false, 0, 0, 0);
        var wall1 = new Obstacle(0, 190, 600, true, 3, 120, 360);
        var wall2 = new Obstacle(1, 0, 250, false, 0, 0, 0);
        var wall3 = new Obstacle(1, 450, 250, false, 0, 0, 0);
        ...
        this.balls = [];
        var ball0 = new MemoryBall(30, 280, 19, 0);
        var ball1 = new MemoryBall(410, 280, 20, 0);
    ...
    __egretProto__.changemove = function () {
...
Gmap6.prototype.__class__ = "Gmap6";
//# sourceMappingURL=Gmap6.js.map