//旅程·一个人的肆意美好
class Gmap3 extends egret.Sprite{
    public constructor() {
        super();
        this.init();
    }
    ...
    { 
        ...
        this.walls = [];
        var wall0: Obstacle = new Obstacle(0,360,600,false,0,0,0);//original settle
        var wall1: Obstacle = new Obstacle(1,200,240,false,0,0,0);//the vertical at middle
        var wall2: Obstacle = new Obstacle(0,0,400,true,3,-120,600);
        var wall4: Obstacle = new Obstacle(0,400,140,true,2,-120,600);
        var wall5: Obstacle = new Obstacle(0,100,50,false,0,0,0);//the one  on the top
        var wall6: Obstacle = new Obstacle(0,240,500,false,0,0,0);// the bottom one
        ...
        this.balls = [];
        var ball0: MemoryBall = new MemoryBall(230,240,9,1);//vertical right
        var ball1: MemoryBall = new MemoryBall(250,460,10,2);//
        var ball3: MemoryBall = new MemoryBall(160,290,11,1);//verticalleft
        var ball4: MemoryBall = new MemoryBall(120,80,12,0);
