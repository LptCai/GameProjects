//青春·盛放
var Gmap4 = (function (_super) {
    __extends(Gmap4, _super);
    function Gmap4() {
        _super.call(this);
        this.memnum = 0;
        this.init();
    }
    var __egretProto__ = Gmap4.prototype;
    ...
    __egretProto__.create_l0 = function () {
        ...
        this.walls = [];
        var wall0 = new Obstacle(0, 240, 330, false, 0, 0, 0); //right horizontal
        var wall1 = new Obstacle(0, 120, 300, false, 0, 0, 0); //left horizontal
        var wall2 = new Obstacle(1, 240, 210, false, 0, 0, 0); //right vertical
        var wall3 = new Obstacle(1, 210, 330, false, 0, 0, 0); //left vertical
        var wall4 = new Obstacle(1, 0, 0, true, 1, -120, 600);
        var wall5 = new Obstacle(1, 450, 480, true, 0, -120, 600);
        ...
        this.balls = [];
        var ball0 = new MemoryBall(180, 260, 13, 0);
        var ball1 = new MemoryBall(170, 360, 14, 0);
        var ball2 = new MemoryBall(240, 380, 15, 0);
    ...
    __egretProto__.resetwall = function () {
        for (var i = 0; i < this.walls.length; i++) {
    ...
    __egretProto__.overnow = function () {
        DataStruct.stage.dispatchEvent(new egret.Event("gameover"));
        this._timer1.stop();
    };
    return Gmap4;
})(egret.Sprite);
Gmap4.prototype.__class__ = "Gmap4";
//# sourceMappingURL=Gmap4.js.map